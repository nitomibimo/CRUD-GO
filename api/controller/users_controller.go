...
// CreateUser - function for create users
...
// GetUsers - function for get all users
...
// GetUser - function for get user per ID
...
// UpdateUser - function for update user param ID
...
// DeleteUser - function for delete user param ID
